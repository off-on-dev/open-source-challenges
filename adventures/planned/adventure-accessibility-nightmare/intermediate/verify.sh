...
DOCS_URL="https://offon.dev/adventures/adventure-accessibility-nightmare/levels/intermediate"
...
check_submission_readiness "adventure-accessibility-nightmare" "intermediate"
